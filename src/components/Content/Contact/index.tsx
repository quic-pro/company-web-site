      ...
      <div className="container py-20">
        <div className="bg-white p-10 max-w-lg mx-auto shadow-lg shadow-gray-400/30">
          ...
          {isValidationCheck !== true ?
            <div>
              <div className="">
                {isValidationCheck === false ?
                  <div className="bg-errorRed-100 border-l-4 border-errorRed-200 text-errorRed-200 p-4 my-4"
                       role="alert">
            ...
            :
            <div className="flex flex-row items-center bg-companyBlue-600 text-white text-sm font-bold px-4 py-3 my-4"
                 role="alert">
