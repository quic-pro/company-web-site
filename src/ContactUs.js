    ...
    return (
        <div class="pt-12">
            ...
            <section class="bg-no-repeat bg-[url('img/image1.jpg')] bg-cover bg-mainBlue opacity-80" style={{ minHeight: '386px', color: 'rgba(9, 162, 255, 0.85)' }}>
                <div class="ph:w-full lg:w-1/2 text-center whitespace-normal mx-auto	">
                    <h2 class="py-7 text-white text-3xl ph:text-xl font-medium">
                    ...
                    <button class="mb-2 inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded  no-underline bg-gray-100 text-gray-800 hover:bg-gray-200 py-3 px-4 leading-tight text-xl" type="button" data-bs-target="#contactus">
